...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.16 — THE SIEGE: record 71.4% decays to a 54%+ plateau → 10 straight ≥50% hours, factory re-arms</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #f87171;padding-left:12px"><b>Verdict (v5.16): THE SIEGE IS THE NEW STEADY STATE. Record 71.4% decayed gently to a 54%+ plateau — ten straight ≥50% hours, still active.</b> The h0 record (71.4%, +20.9pt) did NOT crash like Aug 14's h12 (−21.5pt): it faded h1 65.5% → h2 55.7% → h3 54.4% — the third-highest hour ever, then a <b>new floor at 54–56%</b>, double the 27% lulls of the burst-and-rest era. The ≥50% streak is now <b>10 consecutive hours (h18 → h3), still running</b> — previous max was 7. The factory "quiet" was a 2-hour pause: minting <b>18 → 46 → 575 → 708</b> (h0–h3) — re-armed to sprint scale — but the minting now happens DURING the plateau (h2/h3), no longer 1–6h before a surge: the <b>lead-time rule is formally dead</b>. The standing army is the story: <b>ugmoddev = 15 of 16 hours (h13 → h3)</b>, rate RISING from 95–157/hr to a 166–270/hr band — a 15h+ veteran with no fatigue, the single most persistent farm in 100 hours of tracking. The h0 newcomers were one-hit wonders: srjordan6 (245/hr debut) gone by h1; the disguise repos (nekovach-commits/StockPredictions, SoliSpirit/proxy-list) were single-hour costumes. Naming rotates hourly (template A h1 → A+gibberish h2 → gibberish h3) and h3 deployed a synchronized squad — 7+ actors all at 126–130 pushes/hr, one script. Ledger 26,719 (22,116 confirmed); demotions 2,460 / 2,451 / 1,776; suspicious loops 1,622 at h3.</div>` : ''}
  </section>
