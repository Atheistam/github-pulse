...
const timeline = [
  ...
  { when: "Aug 16 · hours 7–9", title: "The biggest magazine ever fires — deepest dip of the siege, then a 64.1% re-breach (v5.25)", body: "The lead-time rule passed its FIFTH consecutive live test, on the biggest factory output ever measured. The h5+h6 loading (968 + 1,553) did NOT peak at h6: the factory minted 1,630 more at h7 — the biggest single hour since the 2,002 record — then 867, then 608: 5,626 fresh accounts in 5h, and the h5–h7 triple (4,151 in 3h) is the biggest 3h mint ever. The wave followed the playbook exactly: h7 34.4% (−18.3pt, the deepest dip of the entire siege — the batch sat parked, the same fake-out as the 2,002 → 22.5% and the 1,497 → 32.2%), h8 46.5% (+12.1pt), h9 64.1% (+17.6pt) RE-BREACH — a hair under the all-time top-10, wave radar SURGING. Mint→dip→breach in 2–4h (peak mint h7 → breach h9 = 2h). Rotation: ugmoddev's decay is now structural — 95 → 102 → 99 → 74 (from the 364 peak, still 130 of 130 hours); elad-cmd off 4 hours and counting after his 11h marathon; Janfindl is a shift worker, not a resurrected veteran — 123/77/89 (h6–h8), off h9, the same 3-on/1-off cadence as Aug 15; zerotraceh1 NOT retired — returned at h8 after 8 off-hours at his LOWEST intensity ever (68/60 vs his usual 100–220: the cycler comes back weaker each cycle); ThatOneFrench — 4 hours at #1, then gone — was a shift worker, not the new veteran (crown retracted). New naming mutation at h9: hyphenated name + digit suffix (miller-e6513 83, brown-o53700 78, smithm87019 75, jackson-e552804 69). Demotions h9 = 3,585 = NEW ALL-TIME RECORD (previous 3,095). The factory is still loading (608 at h9): another ≥50% hour at h10+ is live-armed. 60 of 130 hours ≥50% · 21.22M events." },
];
...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.25 — THE BIGGEST MAGAZINE EVER FIRES: 1,630 minted at h7 (biggest since the 2,002 record; 4,151 in 3h = all-time 3h record); deepest dip of the siege (h7 34.4%), then h9 re-breach 64.1% — mint→dip→breach, 5th live test passed</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class=\"lede\" style=\"margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px\"><b>VERDICT (v5.25): THE BIGGEST MAGAZINE EVER FIRES — AND THE RULE HOLDS FOR THE FIFTH CONSECUTIVE LIVE TEST.</b> The 2,521-account loading (h5+h6) did NOT peak at h6: the factory minted <b>1,630 more at h7</b> — the biggest single hour since the 2,002 record — then 867, then 608: <b>5,626 fresh accounts in 5 hours</b>, and the h5–h7 triple (<b>4,151 in 3h</b>) is the biggest 3h mint ever measured. The wave followed the playbook exactly: <b>h7 34.4% (−18.3pt)</b> — the deepest dip of the entire siege, the batch sat parked, the same fake-out as the 2,002 → 22.5% and the 1,497 → 32.2% — then <b>h8 46.5% (+12.1pt)</b>, then <b>h9 64.1% (+17.6pt) RE-BREACH</b>, a hair under the all-time top-10, wave radar SURGING. Mint→dip→breach in 2–4h (peak mint h7 → breach h9 = 2h): <b>lead-time live test #3 PASSED — the 5th consecutive live-test win</b>, on the biggest factory output ever. The rotation: <b>ugmoddev's decay is now structural</b> — 95 → 102 → 99 → 74 (from the 364/hr peak; still 130 of 130 hours, the eternal #1); <b>elad-cmd off 4h and counting</b> after his 11h marathon; <b>Janfindl is a shift worker, not a resurrected veteran</b> — 123/77/89 at h6–h8, off h9, the same 3-on/1-off cadence as Aug 15; <b>zerotraceh1 NOT retired</b> — back at h8 after 8 off-hours at his <b>lowest intensity ever</b> (68/60 vs his usual 100–220: the cycler returns weaker each cycle); <b>ThatOneFrench was a shift worker, not the new veteran</b> — 4 hours at #1, then gone (crown retracted). New naming mutation at h9: hyphenated name + digit suffix (miller-e6513 83, brown-o53700 78, smithm87019 75, jackson-e552804 69). <b>Demotions h9 = 3,585 = NEW ALL-TIME RECORD</b> (previous 3,095, Aug 11). The factory is still loading (608 at h9): another ≥50% hour at h10+ is live-armed. Ledger 29,149 actors (26,447 confirmed). 60 of 130 hours ≥50% · 21.22M events.</div>` : ''}
  </section>
