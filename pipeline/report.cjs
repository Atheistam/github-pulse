...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.23 — THE CRACK WAS A ONE-HOUR DIP: 9h siege (h17→h1) broke at h2 48.5%, h3 re-breach 68.9% (+20.4pt = 5th-highest EVER); factory re-armed 575/708 (lead-time rule reborn, 1h lead)</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.24): THE RE-BREACH HELD — THE DEAD CAME BACK — AND THE FACTORY LOADED ITS BIGGEST MAGAZINE SINCE THE RECORD.</b> The one-hour crack at h2 (48.5%) is now confirmed as a blip: the siege resumed and held all three hours — <b>h4 65.8% → h5 57.2% → h6 52.7%</b> — four consecutive ≥50% hours (h3–h6) decaying at a normal −3 to −9pt/hr. <b>Correction to v5.23's headline:</b> the "575 minted h2 + 708 h3" was a script bug (an Aug 15/Aug 16 hour-collision in the minting lookup) — the real dip-hour minting was <b>192 (h2) and 274 (h3)</b>, so the 68.9% re-breach was NOT factory-driven: it was carried by the standing army (ugmoddev 169, elad-cmd 111) plus <b>ThatOneFrench's 196/hr debut</b>. The factory's real answer came AFTER the hold — and it is the biggest since the record: <b>968 fresh accounts at h5 + 1,553 at h6 = 2,521 in 2h</b> — the 2nd-biggest 2h mint EVER (record 2,581, Aug 13) and the biggest single hour since the 2,002 (h12 Aug 14). That loaded magazine points at h7–h8: <b>lead-time rule live test #3 is armed</b>. The veterans: <b>ugmoddev's fatigue is CONFIRMED</b>, not a re-ramp — 364 → 324 → 213 → 169 → 122 → 149 → 95 over 7 hours (still 127 of 127 hours, 100% presence); <b>elad-cmd's 12-hour full-time streak (h19→h5) BROKE at h6</b> (77 → 0) — back to shift rotation; <b>Janfindl — "retired, confirmed" 12 hours ago — RESURRECTED at h6 with 123/hr</b> (#2 farm, AFL_Live): deaths on the botnet are seasonal; zerotraceh1's off-stretch hit 8 hours (longest ever — the cycler's cycle keeps elongating); <b>ThatOneFrench is the new veteran</b> (196/168/141/134, 4th straight hour at #1) — not a one-hit wonder; srjordan6 = two-night one-hit wonder (331/hr at h1, gone by h2 — identical to Aug 15's 245/hr one-shot). Fresh one-hitters: 2awillican988 (80), rite83danil (77), nathydia (84). Demotions heavy and sustained: 2,585 / 2,696 / 2,740 (h6 just below the all-time top-10). Ledger 27,158 actors (23,387 confirmed). 59 of 127 hours ≥50% overall.</div>` : ''}
  </section>
