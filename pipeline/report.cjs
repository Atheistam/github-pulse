...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.30 — THE 18-HOUR SIEGE BREAKS (h3 42.2%, −20.6pt; record run h9→h2 = 18, old record 10) and the factory answers with 1,338 minted AT the dip (4th-biggest ever); zerotraceh1 returns; bogdanstancu decoded as push-spray farm; ledger 26,413 (3rd decline)</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.30): THE 18-HOUR SIEGE FINALLY BREAKS — AND THE FACTORY ANSWERS WITH ITS BIGGEST MAGAZINE IN 44 HOURS. h1 58.5% → h2 62.8% pushed the record run to <b>EIGHTEEN consecutive ≥50% hours (h9 Aug 16 → h2 Aug 17)</b> — the old all-time record was 10 — then h3 collapsed to 42.2% (−20.6pt): the longest breach run ever measured is dead. The collapse came with the factory re-arming AT the dip: 75 → 299 → <b>1,338 fresh accounts minted h1→h3</b> — the 4th-biggest single-hour mint ever (behind only 1,630/1,553/1,497) and the first ≥1,000 magazine since Aug 16 h7 — so the lead-time rule's next live test is armed for h4–h6 (next run). The 18-hour siege itself ran on ~92/hr minting — the standing army IS the wave — but the factory still answers every collapse. <b>zerotraceh1 RETURNED</b> — silent since Aug 16 h9, it pushed 19/24/12 at h1–h3, the cycler coming back exactly as the streak died. elad-cmd ran a clean 3-hour shift (164/157/88, psycho-usage #2 at h2); ugmoddev stayed active all window (266/251/141, noti-api-server 158 at h2) — no zombie gap this time. srjordan6/twoai-content: second straight night (212/183) — a night-shift worker, not a one-hit. New real-word one-hits (flintassemblyduel 320, Fueltricharge 316/210, SkinCorporal 169, SailorEnliven 145, contrerasjake7319 200/132); animal-lover12 = new persistent veteran (8 of 9h, 89–169/hr). <b>CORRECTIONS via archive-level tracing:</b> (1) bogdanstancu1119-maker (710/634/353 — the #1 non-bot actor on GitHub) is NOT a commit-based farm: GH Archive proves 100% PushEvents — it is a <b>push-SPRAY farm</b>, 13 repos at ~27–55 pushes/repo/hr, every repo under the top-15 cutoff, so it never surfaces in bot_watch or demoted (but it IS in the ledger, 62h, and its repos ARE demoted from heat). (2) 'h12-only' was a top-list artifact: archive-level scans of six night hours show 41 of 46 noon-cohort actors are genuinely h12-only, but loganfoxdale drips 18–60/hr at h1–h3 nightly (two days verified) and reinatomait/yonghuy/nuanton ALL pushed at exactly Aug 17 h2 on fresh repos — the scheduler runs an h2 shift too; every earlier 'zero elsewhere' trace missed sub-cutoff activity. (3) ledger hours for veterans are dense first→last intervals — 148/148 is interval coverage, not per-hour activity. Demotions cooled to 1,821/2,310/2,006 — no new all-time entries. Ledger 26,413 (23,414 confirmed) — <b>third consecutive decline</b>. HN: 49310247 alive 39h+ (all-time URL-post record), karma 3 → no posts. 77 of 148 hours ≥50% · 24.25M events.</b></div>` : ''}
  </section>
