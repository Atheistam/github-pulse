...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.20 — PLATEAU BREAKS, LULL LASTS ONE HOUR: h14 37.0% (−14.7pt) → h15 57.1% (+20.1pt) re-breach; factory mints 1,180 in the crash hour (2nd-biggest ever); zerotraceh1 cycler confirmed</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.20): THE PLATEAU BROKE — AND THE LULL LASTED EXACTLY ONE HOUR.</b> The 6-hour ≥50% run (h8–h13) finally crashed at h14: <b>37.0%</b> (−14.7pt) — arriving one hour later and milder than the historical h13-style −20pt collapses, but it came. Then h15 re-breached at <b>57.1% (+20.1pt)</b>, the biggest one-hour swing of the window: <b>7 of the last 8 hours have been ≥50% spam</b>. The factory is now minting IN the crash: h14 minted <b>1,180 fresh accounts — the 2nd-biggest mint ever</b> (record 2,002 at h12 Aug 14), repeating the mint-during-collapse signature; minting has run 15 straight hours (528 → 1,180 → 797). The shift-based veterans <b>elad-cmd and Janfindl</b> both went dark after their h12 shift — 3 consecutive silent hours (h13–h15): the 2-on/2-off rhythm ended in a longer cooldown. <b>zerotraceh1's cycler pattern is now confirmed</b>: h22–23 run → 8h off → h8–h11 run → 1h skip (h12) → h13–h15 run (137/104/102, still active) — a long-cycle actor, not a one-hit wonder. <b>ugmoddev: 26 of 27 hours, present in all 112 tracked hours</b>, and its rate surged back from 104–129 to <b>110 → 127 → 201</b> — no fatigue at 112 hours. New naming disguises: mixed-case alphanumerics (7OG3nOTy50, M7yzM7AqO254, RMBC4BKRu53, l0XeQaHkDEX8z94) alongside template A. Demotions 2,402 / 1,873 / 2,791 — h15's 2,791 is the <b>3rd-biggest demotion hour ever</b>. Ledger 28,897 actors (24,192 confirmed). 46 of 112 hours ≥50% overall.</div>` : ''}
  </section>
