...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.28 — THE RECORD IS TIED: 10 straight ≥50% hours (h9-h18, ties all-time), wave PEAKS at 62.6% on a dead factory (64 minted); noon ritual day six decaying (−69%), twainswee+spl1ce both exactly 75/hr at h12; Janfindl morning shift day 2 confirmed</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.28): THE RECORD IS TIED — A SECOND 10-HOUR SIEGE, PEAKING ON A DEAD FACTORY.</b> h16 55.5% → h17 58.0% → h18 62.6% = <b>TEN consecutive ≥50% hours (h9–h18)</b>, matching the Aug 14/15 siege (h18→h3) as the longest breach run ever measured — and this one is still ALIVE, rising at the end instead of decaying; post-peak-collapse is falsified a fourth time. The factory went quiet again: minting collapsed from the ~500/hr steady-state to 174/146/64 (384 fresh accounts in 3h) — the <b>second record-strength surge on a dead factory</b> (after h0's 71.4% with 18 minted): the standing army IS the wave now. The noon ritual: loganfoxdale's h12-only fingerprint survived a full second negative window (h11–h18 all zero except h12), day-six 109/hr, <b>−69% from peak</b> — and a NEW finding: <b>twainswee AND spl1ce both pushed exactly 75/hr at h12, zero everywhere else</b> — the noon surge may be one shared scheduler, not one actor. <b>Janfindl's morning shift (06:00–08:00Z) confirmed day two</b>: h6 123 / h7 77 / h8 89 — near-identical to day one (105/76/90), cron-regular. ugmoddev: zombie shifts (0/75/0), second parallel repo re-opened (noti-api-server); elad-cmd single 80/hr shift, gaps widening. Demotions held enforcement-record levels (2,957/2,904/2,749): NINE of the top-12 all-time demotion hours now sit in the last ~2 days. NEW disguise template at h18: full realistic names (harringtonkevin8169, hendersonclinton466, butlerstephanie9380) + suffix accounts (-web, -ai, -ui, -debug, -collab). Ledger 27,289 (25,515 confirmed) — first-ever decline (pruning outran the mint). <b>69 of 139 hours ≥50% · 22.74M events.</b></div>` : ''}
  </section>
