...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.26 — THE NOON RITUAL: loganfoxdale/d3 at EXACTLY hour 12 for 6 straight days (312/351/183/227/119/109/hr); 6th lead-time test passed (h10-h12 all ≥50%); ugmoddev out of top-15 for the first time in 133h; demotion record spree (3 of top-6 all-time in one window)</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class=\"lede\" style=\"margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px\"><b>VERDICT (v5.26): THE NOON RITUAL — A FARM THAT PUNCHES THE CLOCK, AND THE ETERNAL #1 FINALLY SLIPS.</b> New fingerprint, the strongest in 133 hours: <b>loganfoxdale/d3 has appeared at EXACTLY hour 12 for SIX consecutive days</b> — 08-11-12 312/hr, 08-12-12 351, 08-13-12 183, 08-14-12 227, 08-15-12 119, 08-16-12 109 — same actor, same repo name <b>d3</b>, a noon-UTC ritual regular enough to be cron-scheduled; it was #1 farm again at h12. Meanwhile <b>ugmoddev fell OUT of the top-15 farm list for the first time in 133 hours</b>: still the 4th most-active actor on all of GitHub (128 events, 70/hr at h12) but under the 71/hr cutoff — rate 158 → 158 → 70, structural decay from the 364/hr peak. The 6th lead-time live test PASSED: the h9 minting (608) fed a sustained breach — <b>h10 62.7% → h11 51.7% → h12 55.4%</b>, four straight ≥50% hours (h9–h12), wave radar PEAK. Rotation: <b>elad-cmd</b> returned h10 (75/hr) after 4h off, then off again h11–h12 (shift pattern intact); <b>Janfindl's 3-on/1-off cadence BROKE</b> — on h6–h8 (123/77/89), then FOUR straight off-hours (h9–h12), a morning-shift pattern (active 06:00–08:00 UTC both days); <b>zerotraceh1's re-ramp was a fade</b> (weakest-ever 68/60, then gone); the hyphen+digit squad (miller-e6513, smithm87019) runs solo on/off shifts, NOT one-hit (83/0/64/0). <b>NEW DISGUISE TIER: real-word usernames</b> — forgetpwd, twainswee, spl1ce, janbeoty, stormart01, reinatomait. <b>Demotion record spree: h9 3,585 (record) + h10 3,225 (2nd-biggest ever) + h11 2,900 (6th)</b> — three of the top-6 all-time demotion hours in ONE window. The factory's magazine is spent (5,626 minted h5–h9), now re-arming at 214/449/440. Ledger 29,065 actors (26,720 confirmed). 63 of 133 hours ≥50% · 21.73M events.</div>` : ''}
  </section>
