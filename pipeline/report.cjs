...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.19 — THE SURGE PLATEAUS: h8–h12 all ≥50% (64.4% → 61.0%, −1.4pt/hr); factory re-arms mid-surge (220 → 497 → 590); veterans go shift-based</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #34d399;padding-left:12px"><b>VERDICT (v5.19): THE REBORN RULE'S WAVE HOLDS — five consecutive ≥50% hours, decaying at −1.4pt/hour instead of collapsing.</b> h8 56.0% → h9 64.4% → h10 62.8% → h11 62.4% → h12 61.0%: the strongest multi-hour plateau since the 10-hour siege, this time at a HIGHER level (61–64% vs 54–56%). The h6 mint (1,497) → h7 dip → h8 breach sequence repeated its signature exactly, and the wave then refused to die — the 2nd siege-like plateau in 36 hours. The factory re-armed MID-surge: minting bottomed at h10 (220 fresh accounts) then climbed 497 → 590 — the 3rd time it has minted during a plateau rather than before one, further burying the lead-time rule. The carrier rotation accelerated: <b>zerotraceh1/er-forge-probe</b> ended its 5-hour run (137/131/139/104 → gone at h12); the <b>base64 squad was the 4th consecutive synchronized squad confirmed as one-hit wonders</b>; and two previously near-continuous veterans — <b>elad-cmd and Janfindl</b> — switched to a SHIFT pattern (active h8–h9, silent h10–h11, back at h12: 83 and 99 pushes/hr): the first evidence the farms are now cycling veterans, not just squads. <b>ugmoddev never stopped</b>: 23 of 24 hours (h13 Aug 14 → h12 Aug 15, only h19 missed) and present in all 109 tracked hours — though its rate finally eased from 194 to 104–129/hr. Fresh faces at h12: loganfoxdale/d3 (119/hr), noahanderson828871 (91/hr), paxpylen. Demotions kept climbing 2,475 / 2,569 / 2,815 — h12's 2,815 is the <b>2nd-biggest demotion hour ever</b> (record: 3,095 at Aug 11 h1). Ledger 28,674 actors. Wave radar: PEAK (61%).</div>` : ''}
  </section>
