...
const timeline = [
  ...
  { when: "Aug 14 · hours 13–15", title: "All-time low → record jump → surge peaks (v5.13)", body: "The lead-time rule's third live test — its strongest — passes. The 2,002-account mint at h12 was followed by the deepest lull ever: h13 fell to 22.5%, a new all-time low (previous low 23.4%), the batch sitting undeployed. Then the surge landed inside the predicted h13–h16 window with the second-biggest single-hour jump in 88 hours: h14 +32.7pt to 55.2%, h15 to 62.4% — the highest since Aug 13's 66.2% peak. Lead from record mint to breach: 2 hours. The mechanics tightened: the h14/h15 surge batch (walexrush36, mackla1962, evansnichole6911, esparzajohn7517, walkererica522, wsch40, paulssand27 — all first_seen h13–h14, pushing 92–104/hr) went from mint to deployment in 1–2 hours, faster than the 2–6h windows of earlier cycles. The factory decelerated but kept re-arming: 614 → 563 → 335 fresh accounts h13–h15. Rotation stayed brutal: h12's top-5 (loganfoxdale 227, williamsjacob1 152) vanished from the top by h13; jvhoang became the new #1 farm (135–143/hr), elad-cmd (96–115) and ugmoddev (95–111) re-ramped, and a fresh template-A batch carried the surge. Demotions 990 / 2,164 / 2,251 farm repos. Mint → lull → surge → re-arm, end-to-end three times." },
];
...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.13 — all-time low (h13 22.5%), record jump (+32.7pt → 55.2%), surge peaks at 62.4%</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #10b981;padding-left:12px"><b>Verdict (v5.13): the lead-time rule passed its THIRD live test — on its strongest signal yet.</b> The record 2,002-account mint at h12 was followed by the deepest lull ever — <b>h13 hit 22.5%, a new all-time low</b> (previous low 23.4%) as the batch sat undeployed — and then the surge landed inside the predicted h13–h16 window: <b>h14 55.2% (+32.7pt, the second-biggest single-hour jump in ${series.length} hours)</b>, h15 <b>62.4% — the highest since Aug 13's 66.2% peak</b>. Lead from the record mint to breach: 2 hours. The mechanics tightened: the surge batch (walexrush36, mackla1962, evansnichole6911, esparzajohn7517, walkererica522, wsch40, paulssand27 — all first_seen h13–h14, pushing 92–104/hr) was minted and deployed within <b>1–2 hours</b>, faster than the 2–6h windows of earlier cycles. The factory decelerated but kept re-arming: 614 → 563 → 335 fresh accounts h13–h15. Rotation stayed brutal: h12's top-5 (loganfoxdale 227, williamsjacob1 152) was gone from the top by h13; jvhoang became the new #1 farm (135–143/hr) with elad-cmd (96–115) and ugmoddev (95–111) re-ramping alongside a fresh template-A batch. Demotions 990 / 2,164 / 2,251 farm repos. Mint → lull → surge → re-arm: the full cycle is now observed end-to-end three times.</div>` : ''}
  </section>
