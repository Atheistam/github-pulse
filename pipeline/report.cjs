...
<main class="wrap">
  ...
  <section class="panel">
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.23): THE CRACK WAS A ONE-HOUR DIP — AND THE FACTORY ANSWERED.</b> The 9-hour siege (h17–h1, all ≥50%, eight ≥65%) finally broke at h2: <b>48.5%</b> (−4.8pt) — the first sub-50% hour since h16, ten hours earlier. The crack lasted exactly ONE hour: h3 re-breached at <b>68.9% (+20.4pt)</b> — the 5th-highest hour EVER and the biggest bounce since the h12→h14 22.5%→55.2% recovery. And this time the factory — idle for a record 9 hours (92/106/31/88/22/20/34/18/46 minted h17–h1) — <b>re-armed: 575 fresh accounts minted at h2 (the dip hour itself), then 708 at h3</b> — 1,283 new identities in 2h. The lead-time rule, declared formally dead at v5.16, returned with its tightest lead ever: <b>mint h2 → breach h3, a 1-hour lead</b>; the h3 batch points at h4+. The standing army shows its first fatigue in days: <b>ugmoddev hit its all-time record 364/hr at h0</b>, then decelerated 324 → 213 → 169 (still 124 of 124 tracked hours — 100% presence); <b>elad-cmd's full-time streak reached 9 hours</b> (h19 → h3: 87→183→111) but is easing; <b>zerotraceh1</b> cycled off (off-stretches growing: 2h → 4h+); <b>Janfindl: 18 silent hours — retired, confirmed</b>. danialzivehdadr ran its 5-hour course (289/229/239/103) and rotated out; new #1 farm: <b>ThatOneFrench/Yugioh-Artwork</b> (196/hr debut). <b>srjordan6</b> — Aug 15's one-hit wonder — RETURNED at h1 with 331/hr (twoai-content). rnfvn mutated again (rogerserik5208/rnfvn-SKFAVD). Demotions 2,161 / 2,082 / 2,562. Ledger 26,461 actors (23,539 confirmed). 56 of 124 hours ≥50% overall.</div>` : ''}
  </section>
