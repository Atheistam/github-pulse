...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.17 — PLATEAU BROKE: 10h siege ends at h4 (40.5%), factory re-arms at 1,497 minted — biggest batch in 3 days</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #f87171;padding-left:12px"><b>Verdict (v5.17): THE PLATEAU WAS NOT A FLOOR — the 10h siege ended at h4, and the factory answered with its biggest re-arm in 3 days.</b> The 54–56% 'steady state' held for exactly 3 hours (h1 65.5% → h2 55.7% → h3 54.4%) before breaking at h4: <b>40.5% (−13.9pt)</b> — the delayed version of the h12 crash (−21.5pt) the record was supposed to avoid, arriving 21 hours later. h5 held 41.8%, then h6 climbed to <b>48.3% (+6.5pt)</b> as the factory went to work: minting <b>466 → 783 → 1,497 (h4–h6)</b> — the 1,497 is the biggest single-hour mint since the 2,002 record, and the first time a ≥1,000 batch was minted DURING a lull. The lead-time rule we declared dead may be reborn: <b>watch h7–h9 for the breach</b>. The standing army never blinked: <b>ugmoddev = 17 of 18 hours (h13 → h6, only h19 missed)</b>, 272/hr at h6 — record band — now running TWO parallel repos (API-NEW-NAT-3- 166 + noti-api-server 106). The h3 synchronized squad (chprotoo / favc17 / cburgegro, 129–130/hr) was gone by h4 — one-hit wonders, exactly as predicted. elad-cmd re-ramped (104–134/hr, 9h seen). New repo-naming tell: <b>6-char gibberish repos</b> (avzkvn, vpjsdm, bqoued) under template-A actors. Ledger 28,830 (23,661 confirmed); demotions 1,501 / 1,647 / 2,146; loops 2,464 at h6.</div>` : ''}
  </section>
