...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.22 — THE PEAK BECAME A PLATEAU: 8 straight hours ≥65% (h20 69.7% = 2nd-highest EVER) on a dead factory (31/88/22/20/34/50 minted); ugmoddev record 364/hr; demotions 3,011 = 2nd-biggest ever</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #fbbf24;padding-left:12px"><b>VERDICT (v5.22): THE PEAK BECAME A PLATEAU — EIGHT STRAIGHT HOURS ≥65% ON A DEAD FACTORY.</b> The 65.8% peak did not collapse — it became a <b>floor</b>: h19 <b>67.5%</b> → h20 <b>69.7% (2nd-highest hour EVER</b>, behind only h0's 71.4%) → h21 68.3% → h22 69.0% → h23 68.6% → h0 65.5%. Eight consecutive ≥50% hours (h17–h0), <b>every single one ≥65%</b> — the strongest sustained run in 121 hours, higher than the 10-hour siege (which dipped into the 50s). And it ran with the factory effectively <b>DEAD</b>: minting fell to <b>31/88/22/20/34/50</b> fresh accounts (245 across six hours vs the 2,002 single-hour record) — the longest idle stretch ever measured. The v5.21 one-hour-lull rhythm was itself a transition: h16 was the last dip. The standing army IS the surge: <b>ugmoddev hit an all-time rate record of 359–364/hr</b> at h23–h0 (121 of 121 tracked hours, dual repos — API-NEW-NAT-3- + noti-api-server); <b>elad-cmd went FULL-TIME for the first time</b> (87 → 111 → 126 → 153 → 131 → 183/hr — the shift pattern is dead); <b>zerotraceh1</b> cycled h19–h23 (120–218/hr) then off at h0, its multi-day rhythm intact; <b>Janfindl: 12 silent hours — retired</b>. New actors: <b>danialzivehdadr/qwen-codep</b> (new #1 farm at h23–h0, 289/hr — a real-sounding repo-name disguise), Kelisiqiang/markwon_formatter (plausible library name), 3215colt/iluxbk. Demotions <b>h19 3,011 = 2nd-biggest hour EVER</b> — four of the top-6 all-time demotion hours now sit in the last four windows. Ledger 26,167 actors (23,096 confirmed). 54 of 121 hours ≥50% overall.</div>` : ''}
  </section>
