...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.18 — RULE REBORN: h6's 1,497 mint → h7 dip (32.2%) → h8 breach (+23.8pt, 56.0%) → h9 64.4% (5th-highest hour ever)</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #34d399;padding-left:12px"><b>VERDICT (v5.18): THE LEAD-TIME RULE IS REBORN — the factory's signature repeated exactly, and the breach landed inside the predicted window.</b> h6 minted <b>1,497</b> fresh accounts (biggest since the 2,002 record) DURING the lull; h7 then <b>dipped to 32.2% (−16.1pt)</b> as the batch sat undeployed — the precise replay of the h12→h13 sequence (2,002 mint → 22.5% all-time low → +32.7pt surge). h8 delivered the breach: <b>56.0% (+23.8pt — the 6th-biggest 1h jump in 106h)</b>; h9 climbed to <b>64.4% — the 5th-highest hour ever</b>, wave radar SURGING. Refined rule: <b>mint ≥500 during a lull → next-hour dip (batch parked) → ≥50% breach within 2h</b>. Mint-to-breach this cycle: 2 hours. The factory minted its biggest-ever 2-hour total (h6 1,497 + h7 1,084 = <b>2,581 fresh accounts</b>) then decelerated (576 → 355) — deploy-then-re-arm intact. The surge ran on a RETURNING veteran — <b>zerotraceh1/er-forge-probe</b> (top farm at h22–h23 at 185–194/hr, absent h0–h7, back at 137/131/hr) — plus a <b>NEW base64-style synchronized squad</b> (J8F8k93gAj26, VPvZkLZTNHf19, ZGXVQhXOjKD29, aLGR5RKc89, 1gRU847VX48, all 74–79/hr) and the standing army: <b>ugmoddev = 20 of 21 hours (h13 → h9)</b>, 180–194/hr during the surge, 2 parallel repos; elad-cmd back (80–85/hr). The h6 squad (jaievicenory10 / mistiane808 / tras82deep) was gone by h7 — <b>3rd consecutive synchronized squad confirmed as one-hit wonders</b>. Naming: 3 generators in 3 hours (lowercase gibberish → NEW base64-alphanumeric → template A). Ledger 29,387 (25,073 confirmed); demotions 1,508 / 2,379 / 2,657 (h9 = 2nd-biggest demotion hour ever); loops 1,928 at h9.</div>` : ''}
  </section>
