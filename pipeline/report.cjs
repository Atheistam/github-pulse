...
<main class="wrap">
  ...
  <section class="panel">
    <div class="panel-head"><h2><span class="h-num">03</span> The 3-hour cadence &amp; the account factory</h2><span class="panel-sub">v5.14 — cycle compresses to ~2–3h (62.4% peak → 43.0% dip → 59.5% re-breach), 4th live test passed</span></div>
    ...
    ${hoursSincePeak !== null ? `<div class="lede" style="margin-top:16px;border-left:3px solid #10b981;padding-left:12px"><b>Verdict (v5.14): the lead-time rule passed its FOURTH live test — and the cycle compressed.</b> After the 62.4% peak at h15 the surge did <b>not</b> decay into a multi-hour lull: h16 fell to 43.0% (−19.4pt) and h17 held 42.6% — then <b>h18 re-breached at 59.5% (+16.9pt)</b>, just 2 hours after the dip. The peak-to-peak cadence tightened from ~5–6h to <b>~2–3h</b> (h14 55.2% → h18 59.5%). The factory made the rule's 4th pass on its tightest lead yet: <b>h17 minted 1,004 fresh accounts → breach at h18, a 1-hour lead</b> (previous leads: 2–6h). The re-breach was carried by a fresh template-A batch (romerosabrina6 135, colemanjeffrey5 130, weaverjames3017 128, gonzalezmichael31 128) — mint-and-burn, 1–2h deploy. The surge batch from h13–h14 rotated out within 1–2h (only wsch40 intermittently returned). A veteran class is emerging: <b>ugmoddev pushed 95–157/hr every hour h12–h18</b> (10+ hours continuous — the first confirmed long-lived farm), with elad-cmd (96–139) and jvhoang (122–143) persisting alongside. Demotions 1,407 / 1,524 / 1,983; ledger 25,372 actors (20,513 confirmed). Mint → lull → surge → re-arm, now observed end-to-end <b>four</b> times, with the cadence visibly accelerating.</div>` : ''}
  </section>
